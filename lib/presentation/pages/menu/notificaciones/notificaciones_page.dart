...
class _NotificacionesPageState extends State<NotificacionesPage> {
  ...
  Future<void> _guardarPreferencias() async {
    ...
    await prefs.setInt('horaInicio_hour', horaInicio.hour);
    await prefs.setInt('horaInicio_minute', horaInicio.minute);
    await prefs.setInt('horaFin_hour', horaFin.hour);
    await prefs.setInt('horaFin_minute', horaFin.minute);
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: const ColorScheme.light(
              primary: Color(0xFFC6DA23), // Verde corporativo
                      ...
                      child: Column(
                        children: [
                          ...
                          ListTile(
                            ...
                            trailing: Container(
                              constraints: const BoxConstraints(maxWidth: 120), // Añadido constraints
                              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 6), // Reducido padding
                              decoration: BoxDecoration(
                                color: const Color(0xFFC6DA23).withAlpha(26), // Reemplazado withOpacity(0.1)
                                borderRadius: BorderRadius.circular(20),
                                border: Border.all(color: const Color(0xFFC6DA23)),
                              ),
                              child: Text(
                                horaInicio.format(context).replaceAll('AM', 'a.m.').replaceAll('PM', 'p.m.'),
                          ...
                          ListTile(
                            ...
                            trailing: Container(
                              ...
                              child: Text(
                                horaFin.format(context).replaceAll('AM', 'a.m.').replaceAll('PM', 'p.m.'),
                                style: const TextStyle(
                                  color: Color(0xFF0067AC),
                                  fontWeight: FontWeight.bold,
                                ),
